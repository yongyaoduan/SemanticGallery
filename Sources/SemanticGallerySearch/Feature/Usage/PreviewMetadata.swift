...
public enum PreviewMetadataLoader {
    public static func load(for item: SearchAsset) throws -> PreviewMetadata {
        try load(fileURL: URL(filePath: item.absolutePath))
    }

    public static func load(fileURL: URL) throws -> PreviewMetadata {

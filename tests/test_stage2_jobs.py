...
class Stage2JobTests(unittest.TestCase):
    ...
    def test_script_runner_emits_structured_progress_updates(self):
        with tempfile.TemporaryDirectory(prefix="sg-stage2-runner-") as tmp_dir:
            ...
            self.assertEqual(progress_events[0]["phaseCurrent"], 0)
            self.assertEqual(progress_events[0]["phaseTotal"], 1)
            self.assertEqual(progress_events[1]["phase"], "prepare")
            self.assertEqual(progress_events[1]["current"], 1)
            self.assertEqual(progress_events[1]["phaseCurrent"], 1)
            self.assertEqual(progress_events[1]["phaseTotal"], 1)
            ...
            self.assertEqual(progress_events[2]["phaseCurrent"], 0)
            self.assertEqual(progress_events[2]["phaseTotal"], 4)
            self.assertEqual(progress_events[3]["message"], "Training epoch 1 of 1 · step 1 of 4")
            self.assertEqual(progress_events[3]["current"], 2)
            self.assertEqual(progress_events[3]["phaseCurrent"], 1)
            self.assertEqual(progress_events[3]["phaseTotal"], 4)
            self.assertEqual(progress_events[4]["message"], "Training epoch 1 of 1 · step 4 of 4")
            self.assertEqual(progress_events[4]["current"], 5)
            self.assertEqual(progress_events[4]["phaseCurrent"], 4)
            self.assertEqual(progress_events[4]["phaseTotal"], 4)
            self.assertEqual(progress_events[5]["phase"], "validate")
            self.assertEqual(progress_events[5]["current"], 6)
            self.assertEqual(progress_events[5]["phaseCurrent"], 1)
            self.assertEqual(progress_events[5]["phaseTotal"], 1)
